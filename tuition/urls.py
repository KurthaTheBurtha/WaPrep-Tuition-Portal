...
urlpatterns = [
    ...
    path('inline-edit-payer-field/', views.inline_edit_payer_field, name='inline_edit_payer_field'),
    path('inline-edit-payment-notes/', views.inline_edit_payment_notes, name='inline_edit_payment_notes'),
    path('payer/upcoming-bills/<int:student_id>/', views.payer_view_upcoming_bills, name='payer_upcoming_bills'),
